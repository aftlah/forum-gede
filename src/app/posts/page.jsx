    ...
    return (
        <>
            <nav className='flex items-center justify-center mx-auto mt-16 bg-red-400 max-w-screen-2xl lg:gap-x-1'>
                <h1 className='max-w-56 font-bold bg-blue-800 text-end lg:text-3xl md:text-[24px] grow md:text-center '>Telusuri di</h1>

                <ul className='flex items-center justify-around bg-green-700 md:grow'>
            ...
            <div className="w-full max-w-[287px]  p-5 bg-white rounded-[10px] mt-5">
                    ...
                    <div className='flex items-center justify-start gap-x-[6px] '>
                        ...
                        <div>
                            <div className='flex flex-col justify-center gap-y-1'>
                                <h1 className='text-[15px] font-bold'>Jhon | Sistem Informasi </h1>
