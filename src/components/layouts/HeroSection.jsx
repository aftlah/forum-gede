...
const HeroSection = () => {
  return (
    // -mt-16
    <section id="hero" className="grid content-center w-full grid-cols-1 px-4 mt-24 mb-32 text-center md:text-start md:grid-cols-2 h-96 place-items-center -z-50">
      ...
      <div className="font-bold text-primary">
        ...
        <Link href={''} className="px-5 py-3 text-base rounded-lg cursor-pointer bg-tertiary drop-shadow-lg">
          Cari Sekarang Juga
        </Link>
      </div>
    </section>
